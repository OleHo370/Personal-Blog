    ...
    <div className="hc-page">
      <div className="hcmainbox">
        ...
        <div className="hccontentbox">
          ...
          <p>I promptly set up an <strong>interview with my grandfather</strong> to gain some firsthand insights into what heart patients struggle with the most. As a result, I identified and narrowed down a niche within heart attack assistance to a feasible scope that I believed I could tackle.</p>
          <p>For example, I learned that <strong>checkups occur infrequently</strong>, around once every six months, meaning that any progression or worsening of the condition may not be detected or treated for an extended period. Additionally, the prescriptions that are given for things such as taking pills and doing exercise are often <strong>lengthy and frequent</strong>, so trying to keep track of every aspect continuously can be quite challenging.</p>
          <p>This foundation allowed me to set a direction for my project and identify the necessary research to refine my idea. As a result, my <strong>problem statement</strong> became:</p>
        ...
        <div className="hccontentbox">
          ...
          <p>During this phase of brainstorming, researching, and refining, I formulated a <strong>definition statement</strong> that highlighted the main goal that my project hopes to achieve:</p>
          ...
          <p>Then, to satisfy the definition statement, I developed a detailed set of <strong>criteria for success</strong> and features that I hoped to include in the final product.</p>

          <h3>General Logistics:</h3>
          <ol>
            <li>A platform that's made in the form of an <strong>online app</strong>, because the information and services that are created should be accessible in a way that the majority of people will be able to use in a free and efficient manner.</li>
            <li>The app will involve both patients and doctors, meaning that <strong>two separate apps</strong> will need to be developed simultaneously, each with distinct functionality and UI.</li>
            <li>The existence of different patients with unique needs and various doctors with access to specific patients' data necessitates a system for <strong>signing up and creating new accounts</strong>, each with its own <strong>unique ID</strong> that can be tracked within an internal system.</li>
            <li>The patient-side app should be accessible through <strong>multiple platforms</strong>, including a computer (as a website), a phone (as a downloadable app from the app store), and a smartwatch (via the iWatch app), to allow for portability wherever the patient is.</li>
            <li>The doctor-side app will just be available on the <strong>computer as a website</strong>, since portability and constant access are not a requirement for the doctor app.</li>
          </ol>
          ...
          <ol>
            <li>
              ...
              <ul>
                <li>There should be a <strong>front page</strong> for whenever a patient or doctor accesses the app, showcasing different options for creating a new account and signing in.</li>
                <li>Inside each option, there should be options for doctor-side sign-in/up and patient-side sign-in/up.</li>
                <li>After the individual has entered <strong>valid credentials</strong> (email and password), the app will search for their specific ID and display their account information on the home page.</li>
              </ul>
            </li>
            <li>
              <span className="hclistheader">Inputting and tracking prescriptions</span>
              <ul>
                <li>Doctors should be able to input specific <strong>prescriptions, exercises, and lifestyle instructions</strong>, along with times, descriptions, and dates, into a form that will then be displayed on the patient-side app's home page. The doctor can do this during a routine checkup or whenever they deem it fit to adjust the health plan. It could also become a <strong>replacement for on-paper prescriptions</strong>, as all the information can be stored on the app.</li>
                <li>After all the information is stored, the app will track each day and hour. When it's time to take a specific medication or perform a particular exercise, the app will send a <strong>notification</strong> to the phone and smartwatch as a reminder.</li>
                <li>After the patient has completed the task, they can <strong>check it off as complete</strong>, and the internal database will track both completed and uncompleted tasks each day.</li>
              </ul>
            </li>
            <li>
              <span className="hclistheader">Patient Data Logging</span>
              <ul>
                <li>Records specific health data of a patient, such as heart rate, by directly using an ECG (electrocardiograph) on a smartwatch, and builds a <strong>report</strong> of the patient's daily health condition.</li>
                ...
                <li>The report will then be available to see on the doctor's side, thus relaying <strong>constant new information</strong> about a patient's well-being.</li>
              </ul>
            </li>
            <li>
              <span className="hclistheader">Communication Between Patients And Doctors</span>
              <ul>
                <li>A <strong>messaging system</strong> within the app will allow for more efficient interaction between the two parties.</li>
              </ul>
            </li>
            <li>
        ...
        <div className="hccontentbox">
          ...
          <img src={patientNoDataImg}></img>
          <p className="hccaption">New Page With No Data Inputted</p>

          <p>When first trying to model the information that would be displayed on the page, I used sample data that I created myself to test the formatting and functionality of the page. I created the sample data in a <strong>JSON file</strong>, where variables and IDs are defined that I reference throughout my data extraction in JavaScript, with the values of those variables being substituted with my temporary data.</p>
          <p>I learned about <strong>Bootstrap formatting and CSS</strong>, which allows me to create different buttons, titles, and tables that fit together in an orderly fashion. I also implemented various functions, such as allowing long tables to be scrollable, so that in cases where there are different screen sizes, people can still access the same information.</p>

          <img src={patientWithDataImg}></img>
          ...
          <img src={prescriptionFormImg}></img>
          ...
          <p>The <strong>Exercises</strong> and <strong>Prescription</strong> modules each have specific inputs with values that are necessary to inform the patient, and each of them has an "Add Exercise/Prescription" and Remove Exercise/Prescription". If a doctor deems it necessary, they can add multiple activities and medications that the patient needs to take. This is achieved in the code by hiding certain functions and using loops to recreate specific chunks of the display. There is a counter for the number of exercises and prescriptions present, each starting at 0, allowing doctors to view the number of each externally. This counter also enables the code to internally track the number of modules to extract data from and display.</p>
          <img src={exercisesImg}></img>
          ...
          <img src={examplePrescriptionImg}></img>
          ...
          <img src={sampleDatesImg}></img>
          <p className="hccaption">Adding a start and end date to the prescription schedule</p>
          <p>Before the form can be submitted, I used <strong>try-catch functions</strong> that I've learned to catch any required boxes that have not been filled.</p>
          <img src={fillOutImg}></img>
          ...
          <p>I redesigned the structure of how the home page is displayed, with each row representing an individual patient. Since I currently only have one test patient, which is my other email account, I manually input a few more different sample patients just to test how the front page would work. Each patient has their own ID and information, which is linked to their personal details, and these are all listed together in an array within another <strong>JSON file</strong>.</p>
          ...
          <p>One of the primary goals of my app was to make it portable, enabling patients to access it anywhere and check on their health at any time. Therefore, I decided to develop a watch app and a phone app. To code an app for those devices, I needed to learn about <strong>Swift</strong>, another programming language.</p>
          ...
          <div className="hcwatchbox">
            <div className="hcmockupitem">
              <img src={watchHomeImg}></img>
              <p className="hccaption">Front Page</p>
            </div>
            <div className="hcmockupitem">
              <img src={watchListImg}></img>
              <p className="hccaption">Sunday</p>
            </div>
            <div className="hcmockupitem">
              <img src={watchList2Img}></img>
              <p className="hccaption">Monday</p>
            </div>
          </div>

          <p>There are a few additional features, including <strong>notifications</strong> and <strong>checkboxes</strong>. The notifications will be a message that pops up whenever a medication needs to be taken or an exercise needs to be done. I learned how to utilize real-life times in the watch so that I can accurately code it to give notifications at the correct time.</p>
